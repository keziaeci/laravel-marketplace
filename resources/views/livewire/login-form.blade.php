<div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <div class="mx-auto max-w-lg">
        ...
        <form wire:submit='auth' class="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8">
            ...
            <div class="flex flex-row justify-between">
                <x-checkbox id="right-label" label="Remember me" wire:model.defer="remember" />
                <span class="text-sm underline">Forgot Password?</span>
            </div>
